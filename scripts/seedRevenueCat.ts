...
const APP_STORE_APP_NAME = 'Football Sudoku iOS';
const APP_STORE_BUNDLE_ID = 'com.footballsudoku.app';
const PLAY_STORE_APP_NAME = 'Football Sudoku Android';
const PLAY_STORE_PACKAGE_NAME = 'com.footballsudoku.app';
